...
from app.services.link_service import create_link, get_user_links, get_link_by_id, update_link, delete_link
...
def get_link(
    ...
    if not db_link or db_link.created_by != current_user.id:
        raise HTTPException(status_code=status.HTTP_403_FORBIDDEN, detail="Not authorized to access this link")
    return db_link
